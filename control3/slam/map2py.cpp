...
PyObject* construct(PyObject* self, PyObject* args){
    ...
    PyArg_ParseTuple(args, "Hbb", &blockSize, &unitSize, &percision);
...
PyObject* getFromIndice(PyObject* self, PyObject* args){
    PyObject* mapArg;
    int x, y;
...
PyObject* getFromDistance(PyObject* self, PyObject* args){
    PyObject* mapArg;
    double x, y;
...
PyObject* getIndiceFromDistance(PyObject* self, PyObject* args){
    PyObject* mapArg;
    double x, y;
...
PyObject* getDistanceFromIndice(PyObject* self, PyObject* args){
    PyObject* mapArg;
    int x, y;
...
PyObject* setByDistance(PyObject* self, PyObject* args){
    PyObject* mapArg;
    double x, y, height;
    uint8_t confidence;
...
PyObject* setByIndice(PyObject* self, PyObject* args){
    PyObject* mapArg;
    int x, y;
    double height;
    uint8_t confidence;
...
PyObject* heightUnitsToMeters(PyObject* self, PyObject* args){
    PyObject* mapArg;
    uint16_t value;
...
PyObject* metersToHeightUnits(PyObject* self, PyObject* args){
    PyObject* mapArg;
    double value;
...
PyObject* applyMinHeightIndice(PyObject* self, PyObject* args){
    PyObject* mapArg;
    int x, y;
    double height;
...
PyObject* applyMaxHeightIndice(PyObject* self, PyObject* args){
    PyObject* mapArg;
    int x, y;
    double height;
...
PyObject* applyDepthImage(PyObject* self, PyObject* args){
    PyObject* mapArg;
    Py_buffer image;
    int height, width;
    float scale;
    double hFov, vFov, x, y, z, rX, rY, rZ;

    PyArg_ParseTuple(args, "Os*fiidddddddd", &mapArg, &image, &scale, &height, &width, &hFov, &vFov, &x, &y, &z, &rX, &rY, &rZ);
    Map* map = (Map*)PyCapsule_GetPointer(mapArg, "MapPtr");

    std::cout << "apply image" << std::endl;
    map->applyDepthImage(static_cast<uint16_t*>(image.buf), scale, height, width, hFov, vFov, x, y, z, rX, rY, rZ);
    std::cout << "post apply image" << std::endl;
    PyBuffer_Release(&image);
    return Py_BuildValue("");
}

//std::pair<int, float*> getPoints();
PyObject* getPoints(PyObject* self, PyObject* args){
    PyObject* mapArg;
    ...
    std::cout << points.first * sizeof(float) << std::endl;
    PyObject* returnValue = Py_BuildValue("iy#", points.first, reinterpret_cast<char*>(points.second), points.first * sizeof(float));
...
PyMethodDef cMapFunctions[] = {
    {"construct", construct, METH_VARARGS, 
    "Create Map object"},
